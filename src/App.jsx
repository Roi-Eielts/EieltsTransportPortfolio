          ...
          <div className='row w-75 mt-3'>
            <div className='col-md-8 d-flex align-items-center flex-row-reverse'>
              <div>
                ...
                <p className='mt-2'>Rond de eeuwwisseling besloot de Harry Eielts sr. te stoppen en is Harry Eielts jr. voort te gaan als zelfstandig rijder geworden onder de naam Eielts transport. </p>
              </div>
            </div>
            <div className='col-md-4 ps-3 pe-2'>
          ...
          <div className='row w-75 mt-3'>
            ...
            <div className='col-md-8 d-flex align-items-center'>
              <div>
                ...
                <p className='mt-2'>In 2010 is de oude vrachtwagen uit ongeveer ±1990/±2000 vervangen door een nieuwe blauwe vrachtwagen, waar ik veel plezier van had. Daarnaast is het koel- en vriestransport gestopt en is volledig overgegaan op bulk- en vloeistofcontainers.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className='ms-5 mt-5 mb-5 d-flex justify-content-center' id='history'>
        <div className='d-flex flex-column align-items-center'>
          ...
          <div className='row w-75 mt-3'>
            ...
            <div className='col-md-4 ps-3 pe-2'>
              <div id="2015" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                  <div className="carousel-inner">
                    ...
                    <button className="carousel-control-prev" type="button" data-bs-target="#2015" data-bs-slide="prev">
                      <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span className="visually-hidden">Previous</span>
                    </button>
                    <button className="carousel-control-next" type="button" data-bs-target="#2015" data-bs-slide="next">
                      <span className="carousel-control-next-icon" aria-hidden="true"></span>
                      <span className="visually-hidden">Next</span>
                    </button>
                  </div>
